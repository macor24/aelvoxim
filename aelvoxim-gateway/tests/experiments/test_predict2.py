"""Test PaddleOCR predict() step by step"""
...
print(f"  img size: {len(img_data)}", flush=True)
...
if result and len(result) > 0:
    ...
    if isinstance(page, dict):
        ...
        print(f"  texts found: {len(texts)}", flush=True)
